...
export default function Footer() {
    ...
    return (
        <>
            <HStack className={style.email_update} display={"flex"}>
                <HStack>
            ...
            <Box bg='#f9f9f9' color='gray.700' pr="80px">
                <Container as={Stack} maxW={'8.5xl'} py={3}>
                    <SimpleGrid columns={{ base: 1, sm: 2, md: 4, lg: 6 }} spacing={8}>
                        ...
                        <Stack align={'flex-start'} className={style.stack}>
                            ...
                            <Link href={'#'}>Open Market Blog</Link>
                        ...
                        <Stack align={'flex-start'} className={style.stack}>
                            ...
                            <Link href={'#'}>Spa Open Market</Link>
                            <Link href={'#'}>Open Market Restaurants</Link>
                            <Link href={'#'}>Open Market Local</Link>
                        </Stack>

                        <Stack align={'flex-start'} className={style.stack}>
                            <ListHeader>Open Market Card & Reward</ListHeader>
                        ...
                        <Stack align={'flex-start'} className={style.stack}>
                            <ListHeader>Open Market, Inc.</ListHeader>
                            <Link href={'#'}>Open Market Rack</Link>
                            <Link href={'#'}>Open Market Canada</Link>
                            <Link href={'#'}>Investor Relations</Link>
                            <Link href={'#'}>Press Releases</Link>
                            <Link href={'#'}>Open Market Media Network</Link>
                        </Stack>
                ...
                <Box
                    ...
                    <Container
                        ...
                        <Text>© 2022 Open Market, Inc.</Text>
                    </Container>
                </Box>
            </Box>
        </>
